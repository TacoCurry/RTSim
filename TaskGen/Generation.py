...
from TaskGen.Utility import Nansu
...
class GenTask:
    ...
    def do_gen_task(input_file):
        ...
        duration = wcet / util_cpu_1task + int(Nansu.get_rand(wcet / util_cpu_1task / 2)) - int(
            Nansu.get_rand(wcet / util_cpu_1task / 2))
        global memreq_1task
